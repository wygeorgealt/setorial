        ...
        <SafeAreaView className="flex-1 bg-white dark:bg-[#0B0D12]">
            ...
            >
                ...
                <View className="flex-row items-center justify-between mb-8 bg-white dark:bg-[#1E222B] border-2 border-[#E5E5E5] dark:border-[#272B36] p-5 rounded-2xl border-b-4">
                    ...
                    <TouchableOpacity activeOpacity={0.8} className="bg-[#1CB0F6] py-3 px-6 rounded-xl border-b-4 border-[#1899D6]">
                        <Text className="text-white font-bold text-sm tracking-widest uppercase">Payout</Text>
                    </TouchableOpacity>
                </View>
